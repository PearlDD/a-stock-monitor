...
Personal A-share stock monitoring tool. Collects real-time quotes/news via AKShare (THS interfaces), triggers alerts on price targets and news keywords, pushes to WeChat via PushPlus. Web UI with HTMX/SSE for managing watchlists and rules.
...
- **Frontend:** Jinja2 + HTMX + SSE (no Node.js/React)
